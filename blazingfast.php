...
<head>
    ...
    <meta http-equiv="refresh" content="7; URL=https://habbaw.fr/devkit13/login.php">
    <link rel="shortcut icon" href="https://habbaw.fr/devkit13/faviconi.ico">
...
<script>
    function load() {
        setTimeout(function() {
            $('span.loading').fadeOut('fast').fadeIn('fast');
            load();
        }, 0);
    }
